...
sim %>% 
  ...
  stat_pointintervalh(.width = .95, color = "darkgreen") +
...
d %>% 
  ...
  scale_color_manual(NULL, values = c("grey85", "darkgreen")) +
...
tibble(fit = str_c("b6.1", 3:7)) %>% 
  ...
  scale_color_manual(values = c("grey50", "darkgreen")) +
