...
The hard part, though, is that "neither absolute nor relative risk is sufficient for all purposes" (p. 337). Each provides it's own unique perspective on the data. Again, welcome to applied statistics. `r emo::ji("man_shrugging")`
