...
ggplot() +
  annotate(geom = "point",
           x = 0.5, y = 0.5, 
           color = "firebrick3", size = 102) +
  annotate(geom = "text",
           x = 0.5, y = 0.5, 
           label = c("Recoding", "Statistical Rethinking", "Second Edition"),
           color = "white", size = c(5, 6, 4) + 2, vjust = c(-4, 0, 4)) +
  coord_equal(xlim = 0:1, ylim = 0:1) +
  theme_void()

ggsave("dot_favicon.png", width = 0.1, height = 0.1, units = "in")
```
