...
# save(list = c("dev_100", "dev_20", "kseq", "n_sim", "n_cores"), file = "/Users/solomonkurz/Dropbox/Recoding Statistical Rethinking/2nd ed/sims/06.sim_1.rda")
...
# save("s", file = "/Users/solomonkurz/Dropbox/Recoding Statistical Rethinking/2nd ed/sims/06.sim_2.rda")
...
```{r, echo = F}
rm(d, m7.1, R2_is_bad, m7.2, m7.3, m7.4, m7.5, m7.6, mass_seq, make_figure7.3, p1, p2, p3, p4, p5, p6, m7.1.1, brain_loo_lines, weatherperson, newcomer, p, t, l, b7.1, lppd_r, lppd_b, make_sim, n_sim, n_cores, kseq, s, n, dev_20, dev_100, dev_tibble, text, cars, b7.m, n_cases, ll, log_mu_l, lppd, v_i, pwaic, b6.6, b6.7, b6.8, w, b5.1, b5.2, b5.3, b5.3t, r2_b5.1, r2)
```
