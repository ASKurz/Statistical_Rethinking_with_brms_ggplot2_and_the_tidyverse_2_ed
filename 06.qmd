# The Haunted DAG & The Causal Terror {#sec-The-Haunted-DAG}
...
### Multicollinear legs {#sec-Multicollinear-legs}
...
If you want to make those cute mini histograms, go back and check out our custom `histospark()` code from @sec-Geocentric-Models.

### A prior is born {#sec-A-prior-is-born}
...
Let's fit a series of models. The priors are based on those we used the last time we saw the `WaffleHouses` data (@sec-Spurious-associations).
