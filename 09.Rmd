...
```{r, fig.width = 6.5, fig.height = 6, message = F, warning = F}
library(GGally)
...
```{r, echo = F}
rm(num_weeks, positions, current, i, proposal, prob_move, pomological_palette, concentration_sim, d, dd, b9.1, post, b9.1b, my_diag, my_lower, b9.2, p1, p2, b9.3, y, b9.4, b9.5, trace_rank, p3, p4, p5, p6)
```
