...
p2 <-
  ...
  geom_smooth(stat = "identity",
              fill = "firebrick", color = "firebrick4", alpha = 1/5, size = 1/4) +
  labs(title = "Counterfactual effect of A on M",
       x = "manipulated A",
       y = "counterfactual M") +
  coord_cartesian(ylim = c(-2, 2)) +
  theme_bw() +
...
```{r, message = F, warning = F, fig.width = 6, fig.height = 1.125}
library(tidybayes)
...
```{r, fig.width = 8, fig.height = 1.125}
