This repository is the GitHub home for my **brms**/**tidyverse** translation of McElreath's [*Statistical rethinking: Second edition*](https://xcelab.net/rm/statistical-rethinking/). You can find the current HTML version of my translation at [https://bookdown.org/content/4857/](https://bookdown.org/content/4857/).
...
Great! I'm guessing most the contributions will fall under:
...
I generally prefer people use the [GitHub issues](https://github.com/ASKurz/Statistical_Rethinking_with_brms_ggplot2_and_the_tidyverse_2_ed/issues) for these. However, it's okay if you prefer to make pull requests. PR's tend to make me nervous and I'm more likely to avoid them in favor of responding to the issues. Sometimes it makes sense to correspond with me by email, but I recommend you use that at a last option.
