...
Our `d` data contains all the components in McElreath's **R** code 3.2 block. Do note we've renamed his `prob_p` and `prob_data` as `prior` and `likelihood`, respectively. Now we'll use the `dplyr::sample_n()` function to sample rows from `d`, saving them as `sample`.
...
Now we can plot theleft panel of Figure 3.1 with `geom_point()`. But before we do, we'll need to add a variable numbering the samples.
...
<img src="03_files/figure-gfm/unnamed-chunk-6-1.png" width="336" style="display: block; margin: auto;" />
...
For convenience, we'll primarily stick to the PI-based intervals in this project.
...
<img src="03_files/figure-gfm/unnamed-chunk-45-1.png" width="336" style="display: block; margin: auto;" />
...
<img src="03_files/figure-gfm/unnamed-chunk-51-1.png" width="336" style="display: block; margin: auto;" />
...
<img src="03_files/figure-gfm/unnamed-chunk-59-1.png" width="288" style="display: block; margin: auto;" />
...
<img src="03_files/figure-gfm/unnamed-chunk-69-1.png" width="336" style="display: block; margin: auto;" />
...
<img src="03_files/figure-gfm/unnamed-chunk-73-1.png" width="672" style="display: block; margin: auto;" />
...
<img src="03_files/figure-gfm/unnamed-chunk-74-1.png" width="288" style="display: block; margin: auto;" />
...
##  [1] brms_2.13.0     Rcpp_1.0.4.6    tidybayes_2.1.1 patchwork_1.0.0 forcats_0.5.0   stringr_1.4.0  
##  [7] dplyr_0.8.5     purrr_0.3.4     readr_1.3.1     tidyr_1.0.2     tibble_3.0.1    ggplot2_3.3.1  
## [13] tidyverse_1.3.0
## 
...
##  [25] bayesplot_1.7.1      jsonlite_1.6.1       broom_0.5.5          dbplyr_1.4.2        
##  [29] ggdist_2.1.1         shiny_1.4.0.2        compiler_3.6.3       httr_1.4.1          
##  [33] emmeans_1.4.5        backports_1.1.7      assertthat_0.2.1     Matrix_1.2-18       
##  [37] fastmap_1.0.1        cli_2.0.2            later_1.0.0          htmltools_0.4.0     
##  [41] prettyunits_1.1.1    tools_3.6.3          igraph_1.2.5         coda_0.19-3         
##  [45] gtable_0.3.0         glue_1.4.1           reshape2_1.4.4       cellranger_1.1.0    
##  [49] vctrs_0.3.1          nlme_3.1-144         crosstalk_1.1.0.1    xfun_0.13           
##  [53] ps_1.3.3             rvest_0.3.5          miniUI_0.1.1.1       mime_0.9            
##  [57] lifecycle_0.2.0      gtools_3.8.2         MASS_7.3-51.5        zoo_1.8-7           
##  [61] scales_1.1.1         colourpicker_1.0     hms_0.5.3            promises_1.1.0      
##  [65] Brobdingnag_1.2-6    sandwich_2.5-1       parallel_3.6.3       inline_0.3.15       
##  [69] shinystan_2.5.0      yaml_2.2.1           gridExtra_2.3        loo_2.2.0           
##  [73] StanHeaders_2.21.0-1 stringi_1.4.6        dygraphs_1.1.1.6     pkgbuild_1.0.8      
##  [77] shape_1.4.4          rlang_0.4.6          pkgconfig_2.0.3      matrixStats_0.56.0  
##  [81] HDInterval_0.2.0     evaluate_0.14        lattice_0.20-38      rstantools_2.0.0    
##  [85] htmlwidgets_1.5.1    labeling_0.3         processx_3.4.2       tidyselect_1.0.0    
##  [89] plyr_1.8.6           magrittr_1.5         bookdown_0.18        R6_2.4.1            
##  [93] generics_0.0.2       multcomp_1.4-13      DBI_1.1.0            pillar_1.4.4        
...
## [109] callr_3.4.3          threejs_0.3.3        reprex_0.3.0         digest_0.6.25       
## [113] xtable_1.8-4         httpuv_1.5.2         stats4_3.6.3         munsell_0.5.0       
