...
<img src="08_files/figure-gfm/unnamed-chunk-4-1.png" width="288" style="display: block; margin: auto;" />
...
<img src="08_files/figure-gfm/unnamed-chunk-7-1.png" width="576" style="display: block; margin: auto;" />
...
<img src="08_files/figure-gfm/unnamed-chunk-10-1.png" width="288" style="display: block; margin: auto;" />
...
<img src="08_files/figure-gfm/unnamed-chunk-12-1.png" width="576" style="display: block; margin: auto;" />
...
<img src="08_files/figure-gfm/unnamed-chunk-15-1.png" width="240" style="display: block; margin: auto;" />
...
## 6 0.8887547 0.01781224 0.8504140 0.9274236   1  0.041379310   -0.1735808      Africa
```
...
<img src="08_files/figure-gfm/unnamed-chunk-21-1.png" width="288" style="display: block; margin: auto;" />
...
##       elpd_diff se_diff elpd_loo se_elpd_loo p_loo  se_p_loo looic  se_looic
## b8.3     0.0       0.0   129.6      7.3         5.0    0.9   -259.2   14.7  
## b8.3t  -19.1       2.7   110.5      8.8         6.2    0.7   -221.0   17.5
```
...
<img src="08_files/figure-gfm/unnamed-chunk-31-1.png" width="576" style="display: block; margin: auto;" />
...
This topic is near and dear my heart. In certain areas of psychology, people presume letters symbols like $\beta$ and $b$ have universal meanings. This presumption is a mistake and will not serve one well beyond a narrow section of the scientific literature. My recommendation is whatever notation you fancy in a given publication, clearly define your terms, especially if there could be any confusion over whether your results are standardized or not.

## Symmetry of interactions

If you're unfamiliar with Buridan's ass, here's a [brief clip](https://www.youtube.com/watch?v=bOp1_LIYvmk) to catch up up to speed. With that ass still on your mind, recall the model for $\mu_i$ from the last example,
...
<img src="08_files/figure-gfm/unnamed-chunk-32-1.png" width="288" style="display: block; margin: auto;" />
...
<img src="08_files/figure-gfm/unnamed-chunk-40-1.png" width="220.8" style="display: block; margin: auto;" /><img src="08_files/figure-gfm/unnamed-chunk-40-2.png" width="220.8" style="display: block; margin: auto;" /><img src="08_files/figure-gfm/unnamed-chunk-40-3.png" width="220.8" style="display: block; margin: auto;" />
...
<img src="08_files/figure-gfm/unnamed-chunk-41-1.png" width="672" style="display: block; margin: auto;" />
...
<img src="08_files/figure-gfm/unnamed-chunk-42-1.png" width="672" style="display: block; margin: auto;" />
...
<img src="08_files/figure-gfm/unnamed-chunk-44-1.png" width="336" style="display: block; margin: auto;" />
...
<img src="08_files/figure-gfm/unnamed-chunk-45-1.png" width="336" style="display: block; margin: auto;" />
...
<img src="08_files/figure-gfm/unnamed-chunk-47-1.png" width="336" style="display: block; margin: auto;" /><img src="08_files/figure-gfm/unnamed-chunk-47-2.png" width="336" style="display: block; margin: auto;" />
...
<img src="08_files/figure-gfm/unnamed-chunk-50-1.png" width="336" style="display: block; margin: auto;" />
...
<img src="08_files/figure-gfm/unnamed-chunk-51-1.png" width="336" style="display: block; margin: auto;" />
...
<img src="08_files/figure-gfm/unnamed-chunk-54-1.png" width="672" style="display: block; margin: auto;" />

I tend to prefer using other plotting methods when visualizing models, so we won't be seeing much more from the `conditional_effects()` function in this ebook. But if you like method, you can find more ideas by checking out the `conditional_effects` section of the [**brms** reference manual](https://cran.r-project.org/package=brms/brms.pdf) [@brms2020RM] or searching for "conditional_effects" under the ["brms" tag on the Stan Forums](https://discourse.mc-stan.org/c/interfaces/brms/36).
...
##  [9] purrr_0.3.4          readr_1.3.1          tidyr_1.1.1          tibble_3.0.4        
...
##  [17] graphlayouts_0.7.0   modelr_0.1.6         RcppParallel_5.0.2   matrixStats_0.57.0  
##  [21] xts_0.12.1           sandwich_2.5-1       prettyunits_1.1.1    colorspace_1.4-1    
##  [25] rvest_0.3.5          ggdist_2.1.1         haven_2.2.0          xfun_0.19           
##  [29] callr_3.5.1          crayon_1.3.4         jsonlite_1.7.1       lme4_1.1-23         
##  [33] survival_3.1-12      zoo_1.8-8            glue_1.4.2           polyclip_1.10-0     
...
##  [49] stats4_3.6.3         StanHeaders_2.21.0-6 DT_0.13              htmlwidgets_1.5.1   
##  [53] httr_1.4.1           threejs_0.3.3        arrayhelpers_1.1-0   ellipsis_0.3.1      
##  [57] farver_2.0.3         pkgconfig_2.0.3      loo_2.3.1            dbplyr_1.4.2        
##  [61] utf8_1.1.4           labeling_0.4.2       tidyselect_1.1.0     rlang_0.4.8         
##  [65] reshape2_1.4.4       later_1.1.0.1        dagitty_0.2-2        munsell_0.5.0       
##  [69] cellranger_1.1.0     tools_3.6.3          cli_2.1.0            generics_0.1.0      
##  [73] broom_0.5.5          ggridges_0.5.2       evaluate_0.14        fastmap_1.0.1       
##  [77] yaml_2.2.1           processx_3.4.4       knitr_1.30           fs_1.4.1            
##  [81] tidygraph_1.2.0      pander_0.6.3         ggraph_2.0.3         nlme_3.1-144        
##  [85] mime_0.9             projpred_2.0.2       xml2_1.3.1           compiler_3.6.3      
##  [89] bayesplot_1.7.2      shinythemes_1.1.2    rstudioapi_0.11      curl_4.3            
##  [93] gamm4_0.2-6          reprex_0.3.0         tweenr_1.0.1         statmod_1.4.34      
##  [97] stringi_1.5.3        ps_1.4.0             Brobdingnag_1.2-6    lattice_0.20-38     
## [101] Matrix_1.2-18        nloptr_1.2.2.1       markdown_1.1         shinyjs_1.1         
## [105] vctrs_0.3.4          pillar_1.4.6         lifecycle_0.2.0      bridgesampling_1.0-0
## [109] estimability_1.3     httpuv_1.5.4         R6_2.5.0             bookdown_0.18       
## [113] promises_1.1.1       gridExtra_2.3        codetools_0.2-16     boot_1.3-24         
## [117] colourpicker_1.0     MASS_7.3-51.5        gtools_3.8.2         assertthat_0.2.1    
## [121] withr_2.3.0          shinystan_2.5.0      multcomp_1.4-13      mgcv_1.8-31         
## [125] parallel_3.6.3       hms_0.5.3            grid_3.6.3           coda_0.19-4         
## [129] minqa_1.2.4          rmarkdown_2.5        ggforce_0.3.1        shiny_1.5.0         
## [133] lubridate_1.7.8      base64enc_0.1-3      dygraphs_1.1.1.6
```
