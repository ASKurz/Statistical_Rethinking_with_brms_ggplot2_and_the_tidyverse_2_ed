...
Do yourself a favor, adopt R Notebooks into your workflow. Do it today. If you prefer to learn with videos, here's a [nice intro](https://youtu.be/TJmNvfhLCoI?t=195) by [Kristine Yu](https://twitter.com/linguist_krisyu) and [another one](https://youtu.be/GG4pgtfDpWY?t=324) by [JJ Allaire](https://twitter.com/fly_upside_down). Try it out for like one afternoon and you'll be hooked.
...
At first, folks were a little shy, but eventually the crowd came through in spades! For a full list, feel free to peruse my tweet thread. For your convenience, here's a list of a good bunch of the works people shared[^10]:
...
##   [1] TH.data_1.1-1        minqa_1.2.4          colorspace_2.0-3     ellipsis_0.3.2       ggridges_0.5.3      
##   [6] rgdal_1.5-30         estimability_1.4.1   markdown_1.1         base64enc_0.1-3      rstudioapi_0.13     
##  [11] farver_2.1.1         rstan_2.21.7         DT_0.24              lubridate_1.8.0      fansi_1.0.3         
##  [16] mvtnorm_1.1-3        bridgesampling_1.1-2 codetools_0.2-18     splines_4.2.0        cachem_1.0.6        
##  [21] knitr_1.40           shinythemes_1.2.0    bayesplot_1.9.0      projpred_2.2.1       jsonlite_1.8.0      
##  [26] nloptr_2.0.3         shiny_1.7.2          httr_1.4.4           compiler_4.2.0       emmeans_1.8.0       
##  [31] backports_1.4.1      assertthat_0.2.1     Matrix_1.4-1         fastmap_1.1.0        cli_3.4.0           
##  [36] later_1.3.0          htmltools_0.5.3      prettyunits_1.1.1    tools_4.2.0          igraph_1.3.4        
##  [41] coda_0.19-4          gtable_0.3.1         glue_1.6.2           reshape2_1.4.4       dplyr_1.0.10        
##  [46] posterior_1.3.1      jquerylib_0.1.4      vctrs_0.4.1          nlme_3.1-159         crosstalk_1.2.0     
##  [51] tensorA_0.36.2       xfun_0.33            stringr_1.4.1        ps_1.7.1             lme4_1.1-30         
##  [56] mime_0.12            miniUI_0.1.1.1       lifecycle_1.0.2      gtools_3.9.3         MASS_7.3-58.1       
##  [61] zoo_1.8-10           scales_1.2.1         colourpicker_1.1.1   promises_1.2.0.1     Brobdingnag_1.2-8   
##  [66] parallel_4.2.0       sandwich_3.0-2       inline_0.3.19        shinystan_2.6.0      curl_4.3.2          
##  [71] gamm4_0.2-6          gridExtra_2.3        ggplot2_3.3.6        loo_2.5.1            StanHeaders_2.21.0-7
##  [76] sass_0.4.2           tweetrmd_0.0.9       stringi_1.7.8        highr_0.9            dygraphs_1.1.1.6    
##  [81] checkmate_2.1.0      boot_1.3-28          pkgbuild_1.3.1       rlang_1.0.6          pkgconfig_2.0.3     
##  [86] matrixStats_0.62.0   distributional_0.3.1 evaluate_0.16        lattice_0.20-45      purrr_0.3.4         
##  [91] labeling_0.4.2       rstantools_2.2.0     htmlwidgets_1.5.4    processx_3.7.0       tidyselect_1.1.2    
##  [96] plyr_1.8.7           magrittr_2.0.3       bookdown_0.28        R6_2.5.1             generics_0.1.3      
## [101] multcomp_1.4-20      DBI_1.1.3            pillar_1.8.1         mgcv_1.8-40          xts_0.12.1          
## [106] sp_1.5-0             survival_3.4-0       abind_1.4-5          tibble_3.1.8         crayon_1.5.1        
## [111] utf8_1.2.2           rmarkdown_2.16       emo_0.0.0.9000       grid_4.2.0           callr_3.7.1         
## [116] threejs_0.3.3        digest_0.6.29        xtable_1.8-4         httpuv_1.6.5         RcppParallel_5.1.5  
## [121] stats4_4.2.0         munsell_0.5.0        bslib_0.4.0          shinyjs_2.1.0
```
