...
This is a companion to the second edition of *Statistical rethinking*. [View the companion to the first edition.](https://bookdown.org/content/3890/)
...
* better sampling in models in the first few due to changes in the `lb` argument;
* more use of the uniform prior for $\sigma$ to better match the text, thanks to the improved `lb` argument;
